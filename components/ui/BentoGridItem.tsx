...
const BentoGridItem = ({
  ...
  const leftLists = ["NextJS", "ReactJS", "Typescript", "Spring Boot", "ojas"];
  const rightLists = ["Javascript", "React Native", "Remix.run", "Tailwind CSS"];

  const [copied, setCopied] = useState(false);

  const handleCopy = () => {
    const text = "OJAS JOSHI.manna98@gmail.com";
